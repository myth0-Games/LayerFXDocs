...
**Already tried out the demo scene and want to start building your own effects?** Jump to the 
...
To properly view LayerFX in action through the demo scene, a few additional setup steps are
...
**LayerFXSample2DRenderer**. Set this renderer as the default renderer.
